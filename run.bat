@echo off
javac -cp "./src/.;src/core.jar;src/javamp3-1.0.4.jar;src/jsyn-20171016.jar;src/sound.jar;src/gst1.jar;src/yt.jar;src/jna.jar;src/video.jar" -d bin/ --release 8 -encoding UTF-8 @sources
cd bin
